...
from Forest_apps.authorization.views.login import login_view, logout_view  # 👈 ИЗМЕНЕНО
from Forest_apps.authorization.views.management_dashboards import (  # 👈 ИЗМЕНЕНО
    supervisor_dashboard, booker_dashboard, mechanic_dashboard,
    master_lpc_dashboard, master_doc_dashboard, master_railways_dashboard
)
