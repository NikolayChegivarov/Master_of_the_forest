...
urlpatterns = [
    ...
    path('logging-site/create/', create_cutting_area_view, name='create_logging_site'),  # 👈 create_logging_site
    path('logging-site/<int:area_id>/edit/', edit_cutting_area_view, name='edit_logging_site'),  # 👈 edit_logging_site
    ...
    path('logging-site/<int:area_id>/fill/', fill_cutting_area_view, name='fill_logging_site'),  # 👈 fill_logging_site
    path('logging-site/<int:area_id>/view/', view_cutting_area_view, name='view_logging_site'),  # 👈 view_logging_site
    ...
    path('materials/create/', material_create_view, name='material_create'),  # должно быть material_create
    path('materials/<int:material_id>/edit/', material_edit_view, name='material_edit'),  # должно быть material_edit
