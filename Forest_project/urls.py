...
urlpatterns = [
    ...
    path('inventory/', include('Forest_apps.inventory.urls')),  # место хранения, движение, остатки, конвертация
    path('operations/', include('Forest_apps.operations.urls')),  # техпроцессы
]